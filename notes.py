...
urla = urllib2.urlopen(
    "https://unacademy.com/lesson/1st-june-2017-daily-mcqs-on-current-affairs-for-government-exams-upsc-cseias-exam/PKSYUA6X").read()
...
for item in a:
    ...
    i = 0
    while 1:
        url = "http://player-images.unacademy.link/%s/images/%s.jpeg" % (
            lession_id, i)
    ...
    with open("output_%s.pdf" % num, "wb") as f:
        f.write(img2pdf.convert(
            [i for i in os.listdir('.') if i.endswith(".jpeg")]))
